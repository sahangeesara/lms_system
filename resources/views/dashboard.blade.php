<x-app-layout>
    ...
    <!-- Student Metric Cards Overview Grid -->
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
        <!-- Card 1 -->
        <div class="bg-white dark:bg-[#131313] p-6 rounded-2xl border border-neutral-200/60 dark:border-neutral-800/60 shadow-sm hover:shadow-md transition-all">
            <div class="flex items-center justify-between mb-3">
                <span class="text-sm font-semibold text-neutral-500 dark:text-neutral-400">Overall Course Progress</span>
            ...
            <div class="w-full bg-neutral-100 dark:bg-neutral-800 h-2 rounded-full mt-4 overflow-hidden">
                <div class="bg-indigo-600 dark:bg-indigo-500 h-full rounded-full transition-all duration-500" style="width: 74%"></div>
            </div>
        </div>
        ...
        <div class="bg-white dark:bg-[#131313] p-6 rounded-2xl border border-neutral-200/60 dark:border-neutral-800/60 shadow-sm hover:shadow-md transition-all">
            <div class="flex items-center justify-between mb-3">
                <span class="text-sm font-semibold text-neutral-500 dark:text-neutral-400">Study Time Goal</span>
                <span class="text-2xl">⏳</span>
            </div>
            <div class="flex items-baseline gap-2">
        ...
        <!-- Card 3 -->
        <div class="bg-white dark:bg-[#131313] p-6 rounded-2xl border border-neutral-200/60 dark:border-neutral-800/60 shadow-sm hover:shadow-md transition-all sm:col-span-2 lg:col-span-1">
            <div class="flex items-center justify-between mb-3">
                <span class="text-sm font-semibold text-neutral-500 dark:text-neutral-400">Completed Modules</span>
                <span class="text-2xl">✅</span>
            </div>
            <div class="flex items-baseline gap-2">
                <span class="text-3xl font-extrabold text-neutral-900 dark:text-white">18 / 24</span>
            </div>
            <p class="text-xs text-neutral-400 mt-4 font-medium">6 modules remaining across 2 active courses.</p>
        </div>
    </div>

    <!-- Academic Grade Predictor Projection Block Title -->
    <div class="mb-4">
