        ...
        <form id="courseForm" action="{{ route('admin.courses.update', $course->id) }}" method="POST" enctype="multipart/form-data"
            ...
            <div>
                ...
                <select id="course_instructor" name="instructor_id" required
                    ...
                    @forelse($instructors ?? [] as $instructor)
                        ...
                        <option value="{{ $instructor->id }}" {{ old('instructor_id', $course->instructor_id) == $instructor->id ? 'selected' : '' }} class="bg-white text-neutral-900">
            ...
            <div class="grid grid-cols-2 gap-4 pt-2">
                <div>
                    ...
                    <select id="course_status" name="status" class="w-full text-sm bg-white border border-neutral-200 rounded-xl px-3 py-2 text-neutral-900 focus:outline-none focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500">
