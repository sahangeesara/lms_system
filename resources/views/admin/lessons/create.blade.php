        ...
        <form id="lessonForm" action="{{ route('admin.lessons.store') }}" method="POST"
            ...
            <div>
                ...
                <textarea id="lesson_content" name="content" rows="6"
                          placeholder="Compose rich text guidelines, instructional guidelines, or source code samples..."
                          class="w-full px-3.5 py-2.5 text-sm bg-white border border-neutral-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500 text-neutral-900 transition-all resize-none">{{ old('content') }}</textarea>
            </div>
